...
print *, '-v, -verbose: print additional diagnostic messages'
...
print *, 'MeteoStatWeightNum = ', xml%sim%n_interpolation_stations
print *, 'MeteoStatTotNum = ', xml%sim%n_weather_stations
