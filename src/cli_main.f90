...
xml%sim%phenology_events_fn =    'phenology_events.txt'
...
xml%sim%cut_irrigation_halt_days =     0
...
print *, 'PhenologyEventsFileName = ', xml%sim%phenology_events_fn
...
print *, 'CutIrrigationHaltDays = ', xml%sim%cut_irrigation_halt_days
